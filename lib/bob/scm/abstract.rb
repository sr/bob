module Bob
  module SCM
    class Abstract
      ...
      # Checkout the code at the specified <tt>commit</tt> and
      ...
      # <tt>commit</tt>. Make sure the user running Bob is allowed to
      # write to this directory (or you'll get a <tt>Errno::EACCESS</tt>)
